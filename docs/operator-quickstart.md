# Operator Quickstart — Crude petroleum extraction

Shortest path from clone to a verified local dry-run for **ISIC 0610** (`cloud-itonami-isic-0610`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-0610.git
cd cloud-itonami-isic-0610
```
...
- Blueprint governor key: `well-safety-governor`
- Likely source path: `crude.governor.cljc`
